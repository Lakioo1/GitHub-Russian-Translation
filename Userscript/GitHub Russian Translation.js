...
(function() {
    ...
    const translations = {
        ...
        'Previously authored commits associated with a public email will remain public.': 'Ранее созданные коммиты, связанные с публичным адресом электронной почты, останутся публичными.',
